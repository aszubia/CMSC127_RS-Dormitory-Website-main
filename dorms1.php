...
<body class="bg-light">
  ...
  ?>
  <div class="my-5 px-4">
    <h2 class="fw-bold h-font text-center">RS Dormitory Manila</h2>
      ...
      <div class="col-lg-11 col-md-12 px-4">
        <div class="card mb-4 border-0 shadow">
          <div class="row g-0 p-4 align-items-center ">
            <?php
            $sql = "SELECT * FROM room_data WHERE dorm_id = 1";
              ...
              <div class="row">
                ...
                <div class="col-md-6 p-0 mb-3">
                  ...
                  <select class="form-control shadow-none" name="room_id" required>
                    ...
                    $sql = "SELECT room_id, room_name FROM room_data WHERE dorm_id = 1";
                    $result = mysqli_query($conn, $sql);
